...
@RestController
@RequestMapping("/api/last-points-kafka")
public class LastPointsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(LastPointsKafkaResource.class);
    ...
    public LastPointsKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
